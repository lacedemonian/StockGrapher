...
implements Serializable {
    ...
    public int hashCode() {
        ...
        long temp = this.top != 0.0 ? Double.doubleToLongBits(this.top) : 0;
        result = 29 * result + (int)(temp ^ temp >>> 32);
        temp = this.bottom != 0.0 ? Double.doubleToLongBits(this.bottom) : 0;
        result = 29 * result + (int)(temp ^ temp >>> 32);
        temp = this.left != 0.0 ? Double.doubleToLongBits(this.left) : 0;
        result = 29 * result + (int)(temp ^ temp >>> 32);
        temp = this.right != 0.0 ? Double.doubleToLongBits(this.right) : 0;
        result = 29 * result + (int)(temp ^ temp >>> 32);
        return result;
    }
