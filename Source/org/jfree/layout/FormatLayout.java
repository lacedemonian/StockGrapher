    ...
    public void layoutContainer(Container parent) {
        ...
        synchronized (object) {
            ...
            for (int rowIndex2 = 0; rowIndex2 < rowCount; ++rowIndex2) {
                int format = this.rowFormats[rowIndex2 % this.rowFormats.length];
                switch (format) {
                    case 1: {
                        c0 = parent.getComponent(componentIndex);
                    ...
                    case 2: {
                        ...
                        c1 = parent.getComponent(componentIndex + 1);
                        c1.setBounds(rowX[1], rowY + (this.rowHeights[rowIndex2] - c1.getPreferredSize().height) / 2, w1to5, c1.getPreferredSize().height);
                        componentIndex += 2;
                        break;
                    }
                    case 3: {
                        ...
                        c0.setBounds(rowX[0], rowY + (this.rowHeights[rowIndex2] - c0.getPreferredSize().height) / 2, this.columnWidths[0], c0.getPreferredSize().height);
                        c1 = parent.getComponent(componentIndex + 1);
                        c1.setBounds(rowX[1], rowY + (this.rowHeights[rowIndex2] - c1.getPreferredSize().height) / 2, w1to4, c1.getPreferredSize().height);
                        c2 = parent.getComponent(componentIndex + 2);
                        c2.setBounds(rowX[5], rowY + (this.rowHeights[rowIndex2] - c2.getPreferredSize().height) / 2, this.columnWidths[5], c2.getPreferredSize().height);
                        componentIndex += 3;
                        break;
                    }
                    case 4: {
                        ...
                        c0.setBounds(rowX[0], rowY + (this.rowHeights[rowIndex2] - c0.getPreferredSize().height) / 2, this.columnWidths[0], c0.getPreferredSize().height);
                        c1 = parent.getComponent(componentIndex + 1);
                        c1.setBounds(rowX[1], rowY + (this.rowHeights[rowIndex2] - c1.getPreferredSize().height) / 2, w1to2, c1.getPreferredSize().height);
                        c2 = parent.getComponent(componentIndex + 2);
                        c2.setBounds(rowX[3], rowY + (this.rowHeights[rowIndex2] - c2.getPreferredSize().height) / 2, this.columnWidths[3], c2.getPreferredSize().height);
                        c3 = parent.getComponent(componentIndex + 3);
                        c3.setBounds(rowX[4], rowY + (this.rowHeights[rowIndex2] - c3.getPreferredSize().height) / 2, w4to5, c3.getPreferredSize().height);
                        componentIndex += 4;
                        break;
                    }
                    case 6: {
                        ...
                        c0.setBounds(rowX[0], rowY + (this.rowHeights[rowIndex2] - c0.getPreferredSize().height) / 2, this.columnWidths[0], c0.getPreferredSize().height);
                        c1 = parent.getComponent(componentIndex + 1);
                        c1.setBounds(rowX[1], rowY + (this.rowHeights[rowIndex2] - c1.getPreferredSize().height) / 2, this.columnWidths[1], c1.getPreferredSize().height);
                        c2 = parent.getComponent(componentIndex + 2);
                        c2.setBounds(rowX[2], rowY + (this.rowHeights[rowIndex2] - c2.getPreferredSize().height) / 2, this.columnWidths[2], c2.getPreferredSize().height);
                        c3 = parent.getComponent(componentIndex + 3);
                    ...
                    case 5: {
                        ...
                        c2.setBounds(rowX[3], rowY + (this.rowHeights[rowIndex2] - c2.getPreferredSize().height) / 2, this.columnWidths[3], c2.getPreferredSize().height);
                        c3 = parent.getComponent(componentIndex + 3);
                        c3.setBounds(rowX[4], rowY + (this.rowHeights[rowIndex2] - c3.getPreferredSize().height) / 2, this.columnWidths[4], c3.getPreferredSize().height);
                        c4 = parent.getComponent(componentIndex + 4);
                        c4.setBounds(rowX[5], rowY + (this.rowHeights[rowIndex2] - c4.getPreferredSize().height) / 2, this.columnWidths[5], c4.getPreferredSize().height);
                        componentIndex += 5;
                        break;
                    }
                    case 7: {
