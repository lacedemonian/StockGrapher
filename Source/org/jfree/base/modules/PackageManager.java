        ...
        try {
            ...
            if (moduleContained == 1) {
                ...
                for (int i2 = 0; i2 < optional.length; ++i2) {
                    if (this.loadModule(optional[i2], incompleteModules, modules, true)) continue;
                    Log.debug(new Log.SimpleMessage("Optional module: ", optional[i2].getModuleClass(), " was not loaded."));
                }
