...
Serializable {
    ...
    public static SegmentedTimeline newMondayThroughFridayTimeline() {
        SegmentedTimeline timeline = new SegmentedTimeline(86400000, 5, 2);
        timeline.setStartTime(FIRST_MONDAY_AFTER_1900);
        return timeline;
    }

    public static SegmentedTimeline newFifteenMinuteTimeline() {
        SegmentedTimeline timeline = new SegmentedTimeline(900000, 28, 68);
    ...
    public long toTimelineValue(long millisecond) {
        ...
        if (groupMilliseconds >= this.segmentsIncludedSize) {
            ...
            if (segment.inExceptionSegments()) {
                result = this.toTimelineValue(segment.getSegmentEnd() + 1);
            } else {
                ...
                long wholeExceptionsBeforeDomainValue = this.getExceptionSegmentCount(this.startTime, millisecond - 1);
                result = x < this.segmentsIncludedSize ? this.segmentsIncludedSize * y + x - wholeExceptionsBeforeDomainValue * this.segmentSize : this.segmentsIncludedSize * (y + 1) - wholeExceptionsBeforeDomainValue * this.segmentSize;
            }
        }
        return result;
    }
    ...
    public long toMillisecond(long timelineValue) {
        ...
        for (long lastIndex = this.startTime; lastIndex <= result.segmentStart; ++lastIndex) {
            ...
            while ((exceptionSegmentCount = this.getExceptionSegmentCount(lastIndex, result.millisecond / this.segmentSize * this.segmentSize - 1)) > 0) {
    ...
    public void addException(long millisecond) {
        this.addException(new Segment(this, millisecond));
    }
    ...
    Serializable {
        ...
        private final /* synthetic */ SegmentedTimeline this$0;
        ...
        protected Segment(SegmentedTimeline this$0, long millisecond) {
            ...
            this.segmentEnd = this.segmentStart + this$0.segmentSize - 1;
        ...
        public long calculateSegmentNumber(long millis) {
            ...
            return (millis - this.this$0.startTime) / this.this$0.segmentSize - 1;
        }
        ...
        public boolean inIncludeSegments() {
            if (this.getSegmentNumberRelativeToGroup() < (long)this.this$0.segmentsIncluded) {
        ...
        public boolean inExcludeSegments() {
            return this.getSegmentNumberRelativeToGroup() >= (long)this.this$0.segmentsIncluded;
        }
