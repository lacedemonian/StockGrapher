...
implements ActionListener {
    ...
    public DefaultPlotEditor(Plot plot) {
        ...
        if (plot instanceof CategoryPlot) {
            LegendItemSource renderer2 = ((CategoryPlot)plot).getRenderer();
            if (renderer2 instanceof LineAndShapeRenderer) {
                r = (LineAndShapeRenderer)renderer2;
        ...
        } else if (plot instanceof XYPlot && (renderer2 = ((XYPlot)plot).getRenderer()) instanceof StandardXYItemRenderer) {
            r = (StandardXYItemRenderer)renderer2;
    ...
    public void updatePlotProperties(Plot plot) {
        ...
        if (this.domainAxisPropertyPanel != null) {
            Axis domainAxis = null;
            if (plot instanceof CategoryPlot) {
                CategoryPlot p3 = (CategoryPlot)plot;
                domainAxis = p3.getDomainAxis();
            } else if (plot instanceof XYPlot) {
                XYPlot p4 = (XYPlot)plot;
                domainAxis = p4.getDomainAxis();
            }
            if (domainAxis != null) {
        ...
        if (this.rangeAxisPropertyPanel != null) {
            ValueAxis rangeAxis = null;
            if (plot instanceof CategoryPlot) {
                CategoryPlot p5 = (CategoryPlot)plot;
                rangeAxis = p5.getRangeAxis();
            } else if (plot instanceof XYPlot) {
                XYPlot p6 = (XYPlot)plot;
                rangeAxis = p6.getRangeAxis();
            }
            if (rangeAxis != null) {
        ...
        if (this.plotOrientation != null) {
            if (plot instanceof CategoryPlot) {
                CategoryPlot p22 = (CategoryPlot)plot;
                p22.setOrientation(this.plotOrientation);
            } else if (plot instanceof XYPlot) {
                p2 = (XYPlot)plot;
                p2.setOrientation(this.plotOrientation);
            }
        }
        if (this.drawLines != null) {
            XYItemRenderer r;
            if (plot instanceof CategoryPlot) {
                ...
                CategoryItemRenderer r2 = p2.getRenderer();
                if (r2 instanceof LineAndShapeRenderer) {
                    ((LineAndShapeRenderer)r2).setLinesVisible((boolean)this.drawLines);
                }
            } else if (plot instanceof XYPlot && (r = (p2 = (XYPlot)plot).getRenderer()) instanceof StandardXYItemRenderer) {
        ...
        if (this.drawShapes != null) {
            ...
            if (plot instanceof CategoryPlot) {
                ...
                CategoryItemRenderer r2 = p2.getRenderer();
                if (r2 instanceof LineAndShapeRenderer) {
                    ((LineAndShapeRenderer)r2).setShapesVisible((boolean)this.drawShapes);
                }
            } else if (plot instanceof XYPlot && (r = (p2 = (XYPlot)plot).getRenderer()) instanceof StandardXYItemRenderer) {
        ...
        if (this.colorBarAxisPropertyPanel != null) {
            ColorBar colorBar = null;
            if (plot instanceof ContourPlot) {
                ContourPlot p7 = (ContourPlot)plot;
                colorBar = p7.getColorBar();
            }
            if (colorBar != null) {
