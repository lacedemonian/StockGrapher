...
Serializable {
    ...
    protected Object[] createItemArray(XYDataset dataset, int series, int item) {
        ...
        result[1] = Double.isNaN(x) && dataset.getX(series, item) == null ? this.nullXString : (this.xDateFormat != null ? this.xDateFormat.format(new Date((long)x)) : this.xFormat.format(x));
