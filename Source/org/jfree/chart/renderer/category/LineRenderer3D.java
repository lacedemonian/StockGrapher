...
Serializable {
    ...
    public void drawBackground(Graphics2D g2, CategoryPlot plot, Rectangle2D dataArea) {
        ...
        if (backgroundImage != null) {
            ...
            g2.drawImage(backgroundImage, (int)x1, (int)y3, (int)(x3 - x1 + 1.0f), (int)(y1 - y3 + 1.0f), null);
    ...
    public void drawItem(Graphics2D g2, CategoryItemRendererState state, Rectangle2D dataArea, CategoryPlot plot, CategoryAxis domainAxis, ValueAxis rangeAxis, CategoryDataset dataset, int row, int column, int pass) {
        ...
        Rectangle2D.Double adjusted = new Rectangle2D.Double(dataArea.getX(), dataArea.getY() + this.getYOffset(), dataArea.getWidth() - this.getXOffset(), dataArea.getHeight() - this.getYOffset());
        PlotOrientation orientation = plot.getOrientation();
        double x1 = domainAxis.getCategoryMiddle(column, this.getColumnCount(), adjusted, plot.getDomainAxisEdge());
        ...
        if (this.getItemLineVisible(row, column) && column != 0 && (previousValue = dataset.getValue(row, column - 1)) != null) {
            ...
            double x0 = domainAxis.getCategoryMiddle(column - 1, this.getColumnCount(), adjusted, plot.getDomainAxisEdge());
