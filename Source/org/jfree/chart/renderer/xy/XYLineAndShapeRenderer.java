...
Serializable {
    ...
    public LegendItem getLegendItem(int datasetIndex, int series) {
        ...
        if (dataset != null && this.getItemVisible(series, 0)) {
            ...
            Paint fillPaint = this.useFillPaint ? this.getSeriesFillPaint(series) : this.getSeriesPaint(series);
            boolean shapeOutlineVisible = this.drawOutlines;
            Paint outlinePaint = this.useOutlinePaint ? this.getSeriesOutlinePaint(series) : this.getSeriesPaint(series);
            ...
            Paint linePaint = this.getSeriesPaint(series);
