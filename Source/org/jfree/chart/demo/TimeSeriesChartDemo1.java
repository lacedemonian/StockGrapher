...
extends ApplicationFrame {
    ...
    private static XYDataset createDataset() {
        ...
        TimeSeries s1 = new TimeSeries("L&G European Index Trust", class_);
        ...
        TimeSeries s2 = new TimeSeries("L&G UK Index Trust", class$org$jfree$data$time$Month == null ? (TimeSeriesChartDemo1.class$org$jfree$data$time$Month = TimeSeriesChartDemo1.class$("org.jfree.data.time.Month")) : class$org$jfree$data$time$Month);
