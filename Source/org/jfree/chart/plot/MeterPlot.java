...
Cloneable {
    ...
    private Paint tickPaint = Color.white;
    ...
    private Paint tickLabelPaint = Color.black;
    ...
    public void draw(Graphics2D g2, Rectangle2D area, Point2D anchor, PlotState parentState, PlotRenderingInfo info) {
        ...
        Rectangle2D.Double originalArea = new Rectangle2D.Double(meterArea.getX() - 4.0, meterArea.getY() - 4.0, meterArea.getWidth() + 8.0, meterArea.getHeight() + 8.0);
        ...
        if (data != null) {
            ...
            if (n != null) {
                ...
                if (this.range.contains(value)) {
                    ...
                    double radius = meterArea.getWidth() / 2.0 + 3.0 + 15.0;
                    double valueAngle = this.valueToAngle(value);
                    double valueP1 = meterMiddleX + radius * Math.cos(3.141592653589793 * (valueAngle / 180.0));
                    double valueP2 = meterMiddleY - radius * Math.sin(3.141592653589793 * (valueAngle / 180.0));
    ...
    protected void drawTick(Graphics2D g2, Rectangle2D meterArea, double value, boolean label) {
        ...
        double valueP1X = meterMiddleX + radius * Math.cos(3.141592653589793 * (valueAngle / 180.0));
        double valueP1Y = meterMiddleY - radius * Math.sin(3.141592653589793 * (valueAngle / 180.0));
        valueP2X = meterMiddleX + radius1 * Math.cos(3.141592653589793 * (valueAngle / 180.0));
        valueP2Y = meterMiddleY - radius1 * Math.sin(3.141592653589793 * (valueAngle / 180.0));
