...
implements Serializable {
    ...
    private void updateBounds(TimePeriod period, int index) {
        ...
        if (this.minMiddleIndex >= 0) {
            ...
            long minMiddle = s + ((e = this.getDataItem(this.minMiddleIndex).getPeriod().getEnd().getTime()) - s) / 2;
            if (middle < minMiddle) {
        ...
        if (this.maxMiddleIndex >= 0) {
            s = this.getDataItem(this.minMiddleIndex).getPeriod().getStart().getTime();
            long maxMiddle = s + ((e = this.getDataItem(this.minMiddleIndex).getPeriod().getEnd().getTime()) - s) / 2;
            if (middle > maxMiddle) {
